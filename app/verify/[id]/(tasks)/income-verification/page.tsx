...
import BankList from "@/app/verify/[id]/(tasks)/income-verification/_components/bank-list";
          ...
          <CarouselContent className={'h-[calc(100dvh-64px)]'}>
                ...
                <div className={'mt-auto flex flex-col gap-2 text-center px-4'}>
                  <div className={'flex gap-2 w-full'}>
                    <Button
                      variant={'link'}
                      size={'lg'}
                      className={'mt-auto shrink-1'}
                      asChild
                    >
                      <Link href={`/verify/${params.id}/tasks`}>Back</Link>
                    </Button>
                    <Button
                      size={'lg'}
            ...
            <CarouselItem className={'h-[calc(100dvh-64px)]'}>
              <div className={'grid grid-rows-[auto,1fr,auto] h-full gap-4'}>
                <h2
                  className={
                    'text-2xl text-gray-900 font-bold mb-4 text-center'
                  }
                >
                  Select your bank
                </h2>
            ...
            <CarouselItem>
              <div className={'h-full flex flex-col px-4'}>
                <SuccessfullyMessage
                  message={'Your Mandiri Bank is successfully connected'}
                />
