      ...
      <>
        ...
        >
          ...
          <div className={'space-y-10'}>
            ...
            <div
              className={
                'flex flex-col items-center gap-4 p-4 rounded-lg border bg-gray-50 w-full'
              }
              {...getRootProps()}
            >
              <input {...getInputProps()} />
          ...
          <div className={'flex w-full justify-between items-center'}>
            <Button variant={'outline'} asChild>
              <Link
                href={`/verify/${params.id}/tasks`}
                className={'text-sm flex gap-1 items-center text-gray-600'}
              >
                {' '}
