    ...
    <div className={'h-dvh grid grid-rows-2 gap-8'}>
      ...
      <div className={'flex flex-col justify-between items-center p-4'}>
          ...
          <CarouselContent>
            ...
            <CarouselItem>
              <div className={'space-y-4'}>
                ...
                <p className={'text-sm text-center text-gray-600'}>
                  We don&lsquo;t share your data with anyone
                </p>
              </div>
            </CarouselItem>
            <CarouselItem>
              <div className={'space-y-4'}>
                ...
                <p className={'text-sm text-center text-gray-600'}>
                  You will receive an email from us once the verification
        ...
        <div className={'flex gap-4 w-full items-center justify-between'}>
          <Link href={`/verify/${params.id}/nationality`} className={'w-full'}>
          ...
          <Button
            ...
            asChild={count === current + 1}
          >
            {count === current + 1 ? (
              <Link href={`/verify/${params.id}/nationality`}>Next</Link>
            ) : (
              'Next'
            )}
          </Button>
